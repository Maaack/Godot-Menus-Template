...
const PLUGIN_REPO_URL = "https://github.com/Maaack/Godot-Menus-Template"
...
static var instance : MaaacksMenusTemplatePlugin
...
func get_copy_path() -> String:
	return MaaacksMenusTemplate.get_copy_path(get_plugin_examples_path())
...
func is_main_scene_set(target_path : String = get_copy_path()) -> bool:
	...
	var new_main_scene_path = target_path + MaaacksMenusTemplate.get_main_scene_relative_path()
...
func _run_opening_scene(target_path : String) -> void:
	var opening_scene_path = target_path + MaaacksMenusTemplate.get_main_scene_relative_path()
...
func _set_default_project_paths() -> void:
	MaaacksMenusTemplate.set_project_paths(get_plugin_examples_path(), false)

func update_project_paths() -> void:
	MaaacksMenusTemplate.set_project_paths(get_copy_path())
...
func _on_completed_copy_to_directory(target_path : String) -> void:
	...
	MaaacksMenusTemplate.set_project_paths(target_path)
	_copy_override_file()
...
func is_partially_installed() -> bool:
	var copy_path : String = MaaacksMenusTemplate.get_copy_path()
...
func _show_plugin_dialogues() -> void:
	var setting_key := MaaacksMenusTemplate.get_settings_path() + "disable_install_wizard"
...
func _install_audio_busses() -> void:
	var setting_key := MaaacksMenusTemplate.get_settings_path() + "disable_install_audio_busses"
	if not ProjectSettings.get_setting(setting_key, false):
...
func _add_tool_options() -> void:
	add_tool_menu_item("Run " + MaaacksMenusTemplate.get_plugin_name() + " Setup...", open_setup_wizard)

func _remove_tool_options() -> void:
	remove_tool_menu_item("Run " + MaaacksMenusTemplate.get_plugin_name() + " Setup...")
