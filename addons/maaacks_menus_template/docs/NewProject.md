...
1.  Finish setup.
    ...
    2.  Update project file paths.
        1.  Go to `Project > Tools > Run Maaack's Menus Template Setup...`.
        2.  In the `Setup Wizard` window next to "Update Project Paths", click `Run`.
...
5.  Continue with:
    ...
    7.  [Adding Custom Options.](/addons/maaacks_menus_template/docs/AddingCustomOptions.md)
