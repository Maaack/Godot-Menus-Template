...
## Selecting a Menu
The main menu by default is `main_menu.tscn`. The path to the main menu is set in the **Project Settings**. Open the **Project > Project Settings > General** tab, navigate to *Maaacks Menus Template* settings, and edit the `Main Menu Scene Path` to the desired scene.
